...
def lst_doc():
    ...
    l=["Dr. Kumar","Dr. Khan","Dr. Singh","Dr. Goel","Dr. Verma","Dr. Jain",]
    ll = l
    m=["Orthopaedic surgeon","Nephrologist","Gynaecologist","Physician","Neurologist",'X-ray']
    n=[10,11,12,13,14,15,]
...
def search_data():
    ...
    label.pack()
    frame=Frame(root7,height=200,width=350)
    frame.pack()
